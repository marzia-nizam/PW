...
public class DrawsandGWP_5 extends PlexusSharedFunctions {
  ...
  public void HowtoEnter()
  {
	  ...
	  PlexusSharedFunctions.ClickablebyXpath(".//*[@id='entry-step-form']/footer/button[2]");
  	 ...
  	 PlexusSharedFunctions.CheckInputProvided(".//*[@id='root']/div/div[2]/div[2]/div/div/section[1]/div/div[2]/section[1]/div[1]/div/section/div[1]/div[3]", "Go to the QA Testing Org's standthe L'Oreal Professionnel training centre in Melbourne and Purchase shampoo");
